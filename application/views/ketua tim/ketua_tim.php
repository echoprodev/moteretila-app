                        ...
                        <div class="page-title-right">
                            ...
                            <div class="dropdown d-inline ">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item has-icon" href="" data-toggle="modal" data-target="#modal-import-ketua_tim">
                                        <i class="mdi mdi-file-import"></i> Upload File
                                    </a>
                                </div>
                            </div>
                            <!-- Modal Import Excel -->
                            <div class="modal fade" id="modal-import-ketua_tim" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        <a href="<?= base_url('ketua_tim/tambah'); ?>" class="btn btn-success btn-sm btn-rounded float-right"><i class="fa fa-plus"></i></a>
                                        <table class="table table-hover table-stripped" id="table1">
                                            <thead>
                                                <tr>
                                                    <th>No</th>
                                                    <th>Nama Ketua Tim</th>
                                                    <th>No Telp Ketua Tim</th>
                                            ...
                                            <tbody>
                                                ...
                                                //$ketua_tim diambil dari key array di controller ketua_tim
                                                //$row untuk penampung datanya
                                                foreach ($ketua_tim as $row) :
                                                    echo "<tr><td>" . $no++ . "</td>
                      <td>" . $row->nama_ketua_tim . "</td>  <td>" . $row->no_telp_ketua_tim . "</td> <td>" . $row->email_ketua_tim . "</td>
                      <td><a href=" . base_url('ketua_tim/ubah/' . $row->id_ketua_tim) . " class='btn
                      btn-warning btn-sm btn-rounded'><i class='fa fa-edit'></i></a>
                      <a href=" . base_url('ketua_tim/hapus/' . $row->id_ketua_tim) . " class='btn
