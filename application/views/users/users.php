                        ...
                        <div class="page-title-right">
                            ...
                            <div class="dropdown d-inline ">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item has-icon" href="" data-toggle="modal" data-target="#modal-import-users">
                                        <i class="mdi mdi-file-import"></i> Upload File
                                    </a>
                                </div>
                            </div>
                            <!-- Modal Import Excel -->
                            <div class="modal fade" id="modal-import-users" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        <a href="<?= base_url('users/tambah'); ?>" class="btn btn-success btn-sm btn-rounded float-right"><i class="fa fa-plus"></i></a>
                                        <table class="table table-hover table-stripped" id="table1">
                                            ...
                                            <tbody>
                                                ...
                                                //$users diambil dari key array di controller users
                                                //$row untuk penampung datanya
                                                foreach ($users as $row) :
                                                    echo "<tr><td>" . $no++ . "</td><td>" . $row->nama_lengkap . "</td>
                      <td>" . $row->username . "</td><td>" . $row->level . "</td>
                      <td><a href=" . base_url('users/ubah/' . $row->id_users) . " class='btn
                      btn-warning btn-sm btn-rounded'><i class='fa fa-edit'></i></a>
                      <a href=" . base_url('users/hapus/' . $row->id_users) . " class='btn
